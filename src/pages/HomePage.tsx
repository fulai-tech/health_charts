  ...
  const routes = [
    ...
    },
    {
      ...
      items: [
        ...
        { path: '/widget/type-7', label: '问卷 Widget', icon: FileText, color: EMOTION_COLORS.primary, alphaColor: EMOTION_COLORS.alpha, type: 7 },
        { path: '/widget/type-10', label: '睡眠血压关系图表 Widget', icon: FileText, color: EMOTION_COLORS.primary, alphaColor: EMOTION_COLORS.alpha, type: 10 },
      ],
    },
  ]
