...
const HEALTH_COLOR = '#F4A261'
/** Target/reference line color */
const TARGET_LINE_COLOR = '#F4A261'
...
const ComprehensiveHealthCardInner = ({
  ...
  const chartData = useMemo(
    () => data?.chartData?.map(item => ({ day: item.day, score: item.score })) ?? placeholderData,
    [data?.chartData]
  )
