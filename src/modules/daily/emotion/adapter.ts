...
export function generateEmotionDemoData(): EmotionDailyData {
    return {
        ...
        chart: [
            { hour: '08:00', label: '08:00-09:00', positive: 60, neutral: 30, negative: 10 },
            { hour: '10:00', label: '10:00-11:00', positive: 50, neutral: 40, negative: 10 },
            { hour: '12:00', label: '12:00-13:00', positive: 40, neutral: 60, negative: 0 },
            { hour: '14:00', label: '14:00-15:00', positive: 30, neutral: 50, negative: 20 },
            { hour: '16:00', label: '16:00-17:00', positive: 20, neutral: 65, negative: 15 },
            { hour: '18:00', label: '18:00-19:00', positive: 35, neutral: 50, negative: 15 },
            { hour: '20:00', label: '20:00-21:00', positive: 45, neutral: 45, negative: 10 },
            { hour: '22:00', label: '22:00-23:00', positive: 55, neutral: 40, negative: 5 },
        ],
        distribution: {
            mainEmotion: 'HAPPY',
